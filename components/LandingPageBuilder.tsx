...
import { 
  ...
  ChevronUp, ChevronDown, Plus, Trash2, ExternalLink
} from 'lucide-react';
    ...
    <div className="flex flex-col lg:flex-row h-[calc(100vh-64px)] bg-slate-950 text-slate-100 overflow-hidden font-sans relative">
      ...
      `}>
        ...
        <div className="h-14 bg-slate-900 border-b border-white/10 flex items-center justify-between px-4 lg:px-6 z-10 shrink-0">
          ...
          {/* Action buttons moved to Floating Panel */}
        </div>
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden p-0 lg:p-8 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] bg-slate-950 flex justify-center pb-24 lg:pb-8 relative">
          ...
          <div className="absolute top-4 right-4 z-50 flex gap-2">
             <button className="flex items-center gap-2 text-xs font-bold bg-black/60 backdrop-blur-md border border-white/10 hover:bg-white/10 text-white px-4 py-2 rounded-full transition-colors shadow-lg">
               <Share2 className="h-3.5 w-3.5" /> Share
             </button>
             <button className="flex items-center gap-2 text-xs font-bold bg-indigo-600/90 backdrop-blur-md hover:bg-indigo-500 text-white px-4 py-2 rounded-full transition-colors shadow-lg shadow-indigo-500/20">
